  ...
  const projects = [
    {
      ...
      link: 'https://modern-cars-website.com',
      category: 'web',
    },
    {
      id: 2,
      ...
      tags: ['HTML', 'CSS', 'JavaScript', 'Flexbox', 'Grid'],
      link: 'https://apple-website-clone.com',
      category: 'web',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      link: 'https://redux-ecommerce.com',
      category: 'ecommerce',
    },
    {
      id: 8,
      ...
      tags: ['HTML', 'CSS', 'JavaScript'],
      link: 'https://demo-university.com',
      category: 'web',
    },
    {
      id: 9,
      ...
      tags: ['React', 'API', 'CSS'],
      link: 'https://react-weather-app.com',
      category: 'app',
    },
  ];
